            ...
            <footer className="footer px-4 md:px-10 border-t-8 border-t-[#00A67E] bg-[#1A1A1A] text-white">
                <div className="flex flex-col md:flex-row justify-between p-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-8">
                        ...
                        <a href="/how-it-works" className="footer-link">Referal</a>
                ...
                <div className='flex flex-col md:flex-row justify-between p-4'>
                    ...
                    <p className="text-center md:text-left">Predict responsibly and never pledge more than you can afford to lose.</p>
                </div>
            </footer>
        </div>
    )
