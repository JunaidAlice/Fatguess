...
const cryptoData = [
  { name: "Bitcoin", symbol: "BTC", image: "https://cryptologos.cc/logos/bitcoin-btc-logo.png", id: "bitcoin" },
  { name: "Ethereum", symbol: "ETH", image: "https://cryptologos.cc/logos/ethereum-eth-logo.png", id: "ethereum" },
  { name: "Solana", symbol: "SOL", image: "https://cryptologos.cc/logos/solana-sol-logo.png", id: "solana" },
  { name: "Cardano", symbol: "ADA", image: "https://cryptologos.cc/logos/cardano-ada-logo.png", id: "cardano" },
];
...
const navLinks = [
  ...
  { name: "Comments", icon: <MessageSquare className="w-5 h-5" />, path: "/comments" },
];
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="relative">
            <button onClick={toggleLanguageDropdown} className="flex items-center space-x-1 text-white">
              <img src={selectedLanguage.flag} alt="Lang Flag" className="w-5 h-5 rounded-full" />
            ...
            {isLanguageDropdownOpen && (
              <div className="absolute top-10 left-0 bg-[#1f1f1f] text-white w-32 rounded-lg shadow-lg">
                {languages.map((language) => (
                  ...
                  >
                    <img src={language.flag} alt={language.name} className="w-5 h-5 rounded-full" />
